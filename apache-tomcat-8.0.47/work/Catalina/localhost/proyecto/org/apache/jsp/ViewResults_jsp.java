 ...
 * Generated at: 2018-05-11 11:36:10 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t<title>Resultados de la búsqueda</title>\n");
...
if(foundrestaurants.size() == 0){
      ...
      out.write("\t\t\t\t<h2 > No hay ningun restaurante del tipo seleccionado </h2>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\n");
      out.write("\t\t\t<table class=\"table table-hover ctr\">\n");
 ...
 for(int i = 0; i< foundrestaurants.size(); i++){ 
      out.write("\n");
      out.write("\t\t\t\t\t<tr class = \"bckgrnd\">\n");
      out.write("\t\t\t\t\t\t<td><a href = \"rest?id=");
      out.print(foundrestaurants.get(i).getIdRest());
      out.write("&cit=");
      out.print(ciudad);
      out.write('"');
      out.write('>');
      out.write(' ');
      out.print( foundrestaurants.get(i).getNameRest() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td> <strong>");
      out.print( foundrestaurants.get(i).getAddressRest() );
      out.write(" </strong></td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t");
 } 
