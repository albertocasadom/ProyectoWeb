 ...
 * Generated at: 2018-05-11 11:31:14 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t<title>Tu pedido</title>\n");
 ...
 if(user.getIdType() == User.TYPE_CUSTOMER){ 
      out.write("\n");
      out.write("\t\t<div class  =\"divclr\">\n");
      out.write("\t\t\t<h2 class = \"ctr\"> ");
      out.print(user.getName());
      out.write(" tu pedido está <i>");
      ...
      out.write("\t\t\t\t<thead class=\"thead-dark ctr\">\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<th> Identificador </th>\n");
      out.write("\t\t\t\t\t\t<th> Fecha y hora </th>\n");
      out.write("\t\t\t\t\t\t<th> Restaurante </th>\n");
      ...
      out.write("\t\t\t\t\t\t<td> ");
      out.print( order.getIdOrder());
      out.write(" </td>\n");
      out.write("\t\t\t\t\t\t<td> ");
      out.print( order.getFechaHora());
      out.write(" </td>\n");
      out.write("\t\t\t\t\t\t<td> ");
      out.print( restaurant.getNameRest());
      out.write(" </td>\n");
      out.write("\t\t\t\t\t\t<td> ");
      out.print( order.getAddressOrder());
      out.write(" </td>\n");
      out.write("\t\t\t\t\t\t<td> ");
      out.print( order.getPrecioTotal());
      out.write(" € </td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t</tbody>\n");
      out.write("\t\t\t</table>\n");
      out.write("\n");
      out.write("\t\t\t<ol class=\"list-group ctr\">\n");
      out.write("\t\t\t\t");
 for(int i=0; i< listaplatos.size(); i++){ 
      out.write("\n");
      out.write("\t\t\t\t\t<li class=\"list-group-item\"> ");
      out.print( listaplatos.get(i).getNamePlate() );
      out.write(' ');
      out.write('x');
      out.write(' ');
      out.print(cantidad[i]);
      out.write(" >> ");
      out.print(listaplatos.get(i).getPrecio());
      out.write(" € </li>\n");
      out.write("\t\t\t\t");
 } 
      out.write("\n");
      ...
      out.write("\t\t\t\t<input type  =\"submit\" class = \"bt btn btn-success\" value = \"Inicio\">\n");
      out.write("\t\t\t</form>\n");
      out.write("\t</body>\n");
      out.write("</html>");
